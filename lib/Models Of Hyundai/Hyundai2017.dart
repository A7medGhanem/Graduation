...
class Hyundai2017 extends StatefulWidget {
  const Hyundai2017({super.key});

  @override
  State<Hyundai2017> createState() => _Hyundai2017State();
}

class _Hyundai2017State extends State<Hyundai2017> {
  CollectionReference user = FirebaseFirestore.instance.collection("Hyundai2017");
      ...
      child: SafeArea(
          ...
          Scaffold(
            appBar: AppBar(
              ...
              title: SizedBox(
                  width:120,
                  child: Text('هيونداي سنتافيه',style: TextStyle(fontFamily: 'ibmB',fontSize: 14,color: Colors.white),)),
              centerTitle: true,
